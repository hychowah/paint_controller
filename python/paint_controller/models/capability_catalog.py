...
_ACTION_CAPABILITIES: dict[str, dict[str, Any]] = {
    ...
    "winch.move_increment": {
        ...
        "surfaceKeys": ["page:winch"],
        "primarySurface": "page:winch",
        "authority": "winchMotionHandler.requestMoveIncrement",
        "capabilityClass": "direct-admin-action",
    ...
    "winch.move_absolute": {
        ...
        "surfaceKeys": ["page:winch"],
        "primarySurface": "page:winch",
        "authority": "winchMotionHandler.requestMoveAbsolute",
        "capabilityClass": "direct-admin-action",
        "legalStateClass": "live-operational-motion",
        "immediateRuntimeSideEffect": True,
        "persistenceKeys": [],
    ...
    "winch.retract_full": {
        ...
        "surfaceKeys": ["page:winch"],
        "primarySurface": "page:winch",
        "authority": "winchMotionHandler.requestRetractFull",
        "capabilityClass": "direct-admin-action",
        "legalStateClass": "live-operational-motion",
        "immediateRuntimeSideEffect": True,
        "persistenceKeys": [],
    ...
    "winch.extend_one_meter": {
        ...
        "surfaceKeys": ["page:winch"],
        "primarySurface": "page:winch",
        "authority": "winchMotionHandler.requestExtendOneMeter",
        "capabilityClass": "direct-admin-action",
        "legalStateClass": "live-operational-motion",
        "immediateRuntimeSideEffect": True,
        "persistenceKeys": [],
    ...
    "winch.emergency_stop": {
        ...
        "surfaceKeys": ["page:winch"],
        "primarySurface": "page:winch",
        "authority": "winchMotionHandler.requestEmergencyStop",
        "capabilityClass": "direct-admin-action",
