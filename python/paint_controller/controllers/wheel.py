...
class WheelController(QObject):
    ...
    def _setup_publishers(self):
        ...
        self._left_wheel_speed_pub = self._node.create_publisher(Float32, 'base/left_track/cmd', 1)
        self._right_wheel_speed_pub = self._node.create_publisher(Float32, 'base/right_track/cmd', 1)
