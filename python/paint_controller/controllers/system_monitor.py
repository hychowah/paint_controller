...
class SystemMonitorWorker(QObject):
    ...
    def _update_battery_info(self) -> None:
        ...
        try:
            ...
            result = subprocess.run(["acpi", "-b"], capture_output=True, text=True, timeout=2)
    ...
    def _update_cpu_temperature(self) -> None:
        ...
        try:
            ...
            result = subprocess.run(["acpi", "-t"], capture_output=True, text=True, timeout=2)
...
class SystemMonitor(QObject):
    ...
    def __init__(self) -> None:
        ...
        self._pending_interval_ms: int | None = None
