...
def _context_objects(monkeypatch, tmp_path: Path) -> dict[str, QObject]:
    ...
    teensy_status = DynamicObject(
        ...
        armRailSpeed=0.0,
        armSensorDist=0.0,
        leftPropPosition=0.0,
        rightPropPosition=0.0,
        leftPropPwm=0,
        rightPropPwm=0,
        sprayGunPitch=0.0,
        gimbalPitchMotorCurrent=0.0,
        gimbalPitchMotorTemp=0.0,
        gimbalRollMotorAngle=0.0,
        gimbalRollMotorCurrent=0.0,
        gimbalRollMotorTemp=0.0,
        sprayGunTrigger=False,
