...
| **P-03** | Status-tick idle early-out (keep 60 Hz e-stop) | Med–High | S–M | **Must preserve safety order** | **Apply-done** (skip only stable idle; always tick on selection change) |
