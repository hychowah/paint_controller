...
- Most recent completed slice: **TD-047 resolved** — façade demirror + `SignalWiringPorts` / `QmlComposePorts` (2026-07-28)
- Debt tracker: software program track active; next **TD-044/045/040** or **TD-048** per `docs/tech-debt.md`
...
- **TD-047 fully resolved** (2026-07-28): façade demirror + ports for wiring/composer.
- **Software program track** (canonical order in `docs/tech-debt.md`): **TD-044/045/040** → **TD-048** (injection depth) → **TD-050** → **TD-049** (device ports) → hygiene (**TD-042/043/051**).
