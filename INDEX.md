...
- **Test suite**: latest verified local full-suite status is `233 passed` on 2026-04-26; focused Workstream B2 validation is green at `39 passed`; revalidate with the venv python before commit if you need a fresher claim
